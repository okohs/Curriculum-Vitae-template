...
- 2017年11月、株式会社ケイブに転職しインフラエンジニアとして既存ゲームの運用保守、新規ゲームのインフラ設計・構築・運用保守を担当
...
- AWS・GMOアプリクラウドを用いたゲームインフラの設計・構築・運用保守
- ZABBIX（Grafana）・CloudWatchを用いた稼働監視
- CDN（Akamai・CloudFront）によるコンテンツ配布
