...
- 業務を円滑にすすめるための環境改善への意欲
    ...
    - ボトルネックとなり得る問題点への追求
        - GoogleAppsScriptを使った、業務の効率化
        - Markdown/VuePressを使った、プロジェクトごとのドキュメント化
...
|職種|フロントエンドエンジニア|
|雇用形態|正社員|
|事業内容|求人企業・エージェント企業向けの求人プラットフォームSARDINEの開発・提供|
|従業員数|50名|
...
#### [既存案件] SARDINE 自社内管理画面・エージェント企業・求人企業向けの開発 (Laravel/PHP)
- タイムライン、メンション機能や、必須入力機能のリプレースに伴う、デザイン設計と実装を担当
- 入社前から現在に至るまで、`登壇駆動開発` を通して自身の設計力は日に日に上がった (知名度も上がった)
- 周囲のフロントエンドエンジニアと切磋琢磨が存在、`知見を発信する` 現在の自身の基本的な姿勢を固めることができた
...
|雇用形態|正社員|
|事業内容|Webフロント・サーバーサイドのAPI開発を含む自社サービスの開発|
|従業員数|100名|

#### サーバーエンジニア室プロジェクトメンバー内訳
- プロジェクトマネージャ・フロントエンドエンジニア 1名 (本人)
- サーバーサイドエンジニア 1名
- インフラエンジニア 1名

#### [新規案件] にゃんこ大戦争 自社内管理画面の開発 (Play/Scala)
- 自社内管理画面のリプレースのみならず、`地下鉄に乗ろう` という京都市営地下鉄とのスピンオフ企画など多岐に渡った
- イベント管理や、マスタ管理ではGAS連携の作業も遂行
-　なめすた同様、`クリーンアーキテクチャ` の下で着実な開発を実現

#### [新規案件] なめすた 自社内管理画面の開発 (Laravel/PHP)
- ゲーム内ブラウザも、制作を担当
- お知らせ、アイテム付与、ガチャ、マスタ、イベント管理
- `クリーンアーキテクチャ` を下に緻密なComponent設計の下で、着実な開発を実現
...
#### [既存案件] リモート視聴アプリの開発 (Objective-C/C++)
- クライアントとのやり取りを受けた改善から、提案・デザイン業務まで担当
- 視聴可能年齢を設定するパレンタル制御を担当
...
|key|value|
|---|-----|
|職種|iOSエンジニア・業務開発エンジニア|
|雇用形態|正社員|
|事業内容|業務系アプリケーション開発・iOSアプリケーション制作|
|従業員数|1000名|

#### 受託チームプロジェクトメンバー内訳
- プロジェクトリーダ 1名
- サブリーダ 1名
- iOSエンジニア・業務開発エンジニア 6名 (本人)

#### [新規案件] 勤怠管理アプリケーションの開発 (Realm/ObjectiveーC)
- サーバサイドにPHPを使っており、その連携も担当

#### [既存案件] 受発注管理アプリケーションの開発 (.NET)
- 一般的なアプリケーションの開発を設計から実装、テストまで担当
- アプリケーションの開発工程を理解
